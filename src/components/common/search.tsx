...
export default function Search() {
	...
	const [immediateSearchText, setImmediateSearchText] = React.useState("");
	...
	).current; // Set the debounce delay to 1000 milliseconds

	function handleAutoSearch(e: React.FormEvent<HTMLInputElement>) {
		const text = e.currentTarget.value;
		setImmediateSearchText(text); // Update immediately
